...
local function on_attach()
  ...
  keymap("n", "<leader>ej", vim.diagnostic.goto_next,     { buffer = 0 }) --> goto next error
  keymap("n", "<leader>ek", vim.diagnostic.goto_prev,     { buffer = 0 }) --> goto previous error
  keymap("n", "<leader>et", ":Telescope diagnostics<CR>", { buffer = 0 }) --> telescope error
end
